...
urlpatterns = [
    ...
    path('reader-faculty/', views.create_reader_faculty, name='create_reader_faulty'),
    ...
    path('delete-reader-faulty/', views.delete_reader_faculty, name='delete_reader_faulty'),
    path('update-reader-faulty/', views.update_reader_faculty, name='update_reader_faulty'),
