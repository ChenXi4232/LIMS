...
class UserInfo(AbstractUser):
    roles = models.CharField(max_length=20, default="Reader", verbose_name="权限")
    introduction = models.TextField(max_length=255, verbose_name="个人简介")
...
class ReaderFaculty(models.Model):
    reader_card_id = models.OneToOneField(Reader, on_delete=models.CASCADE, verbose_name="读者证 ID", primary_key=True)
...
class BorrowingInfo(models.Model):
    ...
    due_date = models.DateField(verbose_name="应还日期", blank=True, null=True)
